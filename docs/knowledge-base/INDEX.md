...
- `testovi/4-integracioni-testovi.md` — Šta integracioni test izvršava, upravljane i neupravljane zavisnosti, koje scenarije pokriva, pokretanje aplikacije u testu. Preduslovi: `3-mapa-testiranja-serverskih-komponenti.md`, `server/1-aspnet/2-kontroleri.md`.
