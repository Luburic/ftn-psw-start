...
- `server/2-arhitektura-modula/3-infrastrukturni-sloj/6-ostali-infrastrukturni-servisi.md` — Konektorske i stručnjačke klase: sposobnost kroz drugi sistem ili kroz biblioteku, oblik interfejsa tehničke sposobnosti. Preduslovi: `5-jedinica-posla.md`, `server/arhitektura/ddd/5-domenski-servis.md`.
