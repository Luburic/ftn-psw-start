...
2. [Aspekti kvaliteta testa](2-aspekti-kvaliteta-testa.md) - Kako se za dati test odlučuje da li ga vredi zadržati. Cilj testiranja, zaštita od regresija, otpornost na refaktorisanje i lažni pozitivi, brzina i održivost, vrednost kao proizvod.
...
4. [Integracioni testovi](4-integracioni-testovi.md) - Šta integracioni test izvršava i koje scenarije pokriva. Upravljane i neupravljane zavisnosti, uspešan scenario i odbijanja van domena, pokretanje aplikacije u testu, prijavljeni korisnik, organizacija test projekta.
