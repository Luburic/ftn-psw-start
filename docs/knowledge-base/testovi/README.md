...
2. [Šta čini dobar test](2-sta-cini-dobar-test.md) - Kako se za dati test kaže da li vredi. Cilj testiranja, zaštita od regresija, otpornost na refaktorisanje i lažni pozitivi, brzina i održivost, vrednost kao proizvod.
