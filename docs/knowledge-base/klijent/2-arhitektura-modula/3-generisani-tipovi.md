...
Scope: DTO types as the wire contract, generated per module; hand-written client models beside them.
...
7. models/ beside api/: hand-written client-only shapes, with the comment edit payload as the example, since it exists only to carry an output [code + text]
