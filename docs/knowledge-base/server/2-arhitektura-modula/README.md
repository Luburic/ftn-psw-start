...
3. [Infrastrukturni sloj](3-infrastrukturni-sloj/README.md) - Pet lekcija o radu sa bazom podataka kroz objektno-relacioni maper: zašto maper postoji, kako kontekstna klasa i model mapiranja opisuju klase bazi, kako migracije bazu drže u koraku sa modelom, kako repozitorijumi učitavaju agregate i projektuju podatke za prikaz i kako jedinica posla sve izmene jedne komande upisuje odjednom.
4. [API sloj](4-api-sloj.md) - Kontroler po grupi slučajeva korišćenja, tri koraka svake akcije, odakle akciji identifikator korisnika i šta akcija prepušta drugim slojevima. Oslanja se na [lekciju o kontrolerima](../1-aspnet/2-kontroleri.md).
5. [Čista arhitektura](5-čista-arhitektura.md) - Sva četiri sloja sagledana zajedno: put jedne komande i jednog upita od HTTP zahteva do odgovora, odgovornosti po slojevima i precizno pravilo o zavisnostima između slojeva. Čita se poslednji, kao zaokruženje direktorijuma.
